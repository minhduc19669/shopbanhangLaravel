                ...
                <div class="col-sm-9 padding-right">
                    ...
                    <div class="category-tab shop-details-tab"><!--category-tab-->
                        <div class="col-sm-12">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#" data-toggle="tab">Company Profile</a></li>
                                <li><a href="#" data-toggle="tab">Tag</a></li>
                                <li><a href="#" data-toggle="tab">Reviews (5)</a></li>
                            </ul>
                        </div>
                        <div class="tab-content">
                            <div class="tab-pane fade active in" id="details">
                                <div class="col-sm-12">
                                    <p></p>
                                    <p><b>{!!$pro->product_desc!!}</b></p>
                                    <form action="#">
										<span>
											<input type="text" placeholder="Your Name"/>
											<input type="email" placeholder="Email Address"/>
										</span>
                                        <p style="margin-top: 10px">Write Your Review</p>
                                        <textarea name=""></textarea>
                                        <b>Rating: </b> <img src="{{asset('images/product-details/rating.png')}}" alt=""/>
                                        <button style="margin-top: 10px;background-color: #fb6f6b" type="button" class="btn btn-default pull-right">
                                            Send
                                        </button>
                                    </form>
                                </div>
                    ...
                    <div class="recommended_items"><!--recommended_items-->
                        ...
                        <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="item active">
                                    @foreach($ortherProducts as $value)
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="{{asset('uploads/product/'.$value->product_image)}}" style="width: 150px;height: 100px" alt=""/>
                                                    <h2>$56</h2>
